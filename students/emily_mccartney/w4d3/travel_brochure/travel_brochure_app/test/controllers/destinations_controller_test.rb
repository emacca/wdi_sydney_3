...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { description: @destination.description, location: @destination.location, name: @destination.name }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { description: @destination.description, location: @destination.location, name: @destination.name }
    assert_redirected_to destination_path(assigns(:destination))
  end
